...
import listBasedKendallAlgorithms.TilesWithSimpleSortersListReaderKendallCalculator;
...
public class AlgoSimpleSortersTest {
    ...
    public AlgoSimpleSortersTest(String path, String column1, String column2, String delimiter, double expected) {
        this.path = path;
    ...
    public void testCalculateListSimpleTilesSimpleSrvc() {
        ...
        TilesWithSimpleSortersListReaderKendallCalculator calculator = new TilesWithSimpleSortersListReaderKendallCalculator(params);
